package mm.pndaza.atthakathanissaya.utils;
...
public class Rabbit {
    ...
    public static String uni2zg(String input) {
        ...
        rule.put("\u100f\u1039\u100d", "\u1091");
        rule.put("\u100b\u1039\u100b", "\u1097");
        rule.put("([\u1000-\u1021\u108f\u1029\u106a\u106e\u106f\u1086\u1090\u1091\u1092\u1097])([\u1060-\u1069\u106c\u106d\u1070-\u107c\u1085\u108a\u1093])?([\u103b-\u103e]*)?\u1031", "\u1031$1$2$3");
        rule.put("\u103c\u103e", "\u103c\u1087");
        rule.put("([\u1000-\u1021\u108f\u1029])([\u1060-\u1069\u106c\u106d\u1070-\u107c\u1085])?(\u103c)", "$3$1$2");
        rule.put("\u103a", "\u1039");
        rule.put("\u103b", "\u103a");
        rule.put("\u103c", "\u103b");
        rule.put("\u103d", "\u103c");
        ...
        rule.put("([\u101b\u103a\u103c\u108a\u1088\u1090])([\u1030\u103d])?([\u1032\u1036\u1039\u102d\u102e\u108b\u108c\u108d\u108e]?)(\u102f)?\u1037", "$1$2$3$4\u1095");
        rule.put("([\u102f\u1014\u1030\u103d])([\u1032\u1036\u1039\u102d\u102e\u108b\u108c\u108d\u108e]?)\u1037", "$1$2\u1094");
        rule.put("([\u103b])([\u1000-\u1021])([\u1087]?)([\u1036\u102d\u102e\u108b\u108c\u108d\u108e]?)\u102f", "$1$2$3$4\u1033");
        rule.put("([\u103b])([\u1000-\u1021])([\u1087]?)([\u1036\u102d\u102e\u108b\u108c\u108d\u108e]?)\u1030", "$1$2$3$4\u1034");
        rule.put("([\u103a\u103c\u100a\u1008\u100b\u100c\u100d\u1020\u1025])([\u103d]?)([\u1036\u102d\u102e\u108b\u108c\u108d\u108e]?)\u102f", "$1$2$3\u1033");
        rule.put("([\u103a\u103c\u100a\u1008\u100b\u100c\u100d\u1020\u1025])(\u103d?)([\u1036\u102d\u102e\u108b\u108c\u108d\u108e]?)\u1030", "$1$2$3\u1034");
        rule.put("([\u100a\u1020\u1009])\u103d", "$1\u1087");
        rule.put("\u103d\u1030", "\u1089");
        rule.put("\u103b([\u1000\u1003\u1006\u100f\u1010\u1011\u1018\u101a\u101c\u101a\u101e\u101f])", "\u107e$1");
        rule.put("\u107e([\u1000\u1003\u1006\u100f\u1010\u1011\u1018\u101a\u101c\u101a\u101e\u101f])([\u103c\u108a])([\u1032\u1036\u102d\u102e\u108b\u108c\u108d\u108e])", "\u1084$1$2$3");
        rule.put("\u107e([\u1000\u1003\u1006\u100f\u1010\u1011\u1018\u101a\u101c\u101a\u101e\u101f])([\u103c\u108a])", "\u1082$1$2");
        rule.put("\u107e([\u1000\u1003\u1006\u100f\u1010\u1011\u1018\u101a\u101c\u101a\u101e\u101f])([\u1033\u1034]?)([\u1032\u1036\u102d\u102e\u108b\u108c\u108d\u108e])", "\u1080$1$2$3");
        rule.put("\u103b([\u1000-\u1021])([\u103c\u108a])([\u1032\u1036\u102d\u102e\u108b\u108c\u108d\u108e])", "\u1083$1$2$3");
        rule.put("\u103b([\u1000-\u1021])([\u103c\u108a])", "\u1081$1$2");
        rule.put("\u103b([\u1000-\u1021])([\u1033\u1034]?)([\u1032\u1036\u102d\u102e\u108b\u108c\u108d\u108e])", "\u107f$1$2$3");
        rule.put("\u103a\u103d", "\u103d\u103a");
        rule.put("\u103a([\u103c\u108a])", "$1\u107d");
        rule.put("([\u1033\u1034])(\u1036?)\u1094", "$1$2\u1095");
        rule.put("\u108F\u1071", "\u108F\u1072");
        rule.put("\u108F\u1073", "\u108F\u1074");
//        rule.put("([\u1000-\u1021])([\u107B\u1066])\u102C", "$1\u102C$2");
//        rule.put("\u102C([\u107B\u1066])\u1037", "\u102C$1\u1094");
        rule.put("\u1047((?=[\u1000-\u1021]\u1039)|(?=[\u102c-\u1030\u1032\u1036-\u1038\u103c\u103d]))", "\u101b");
    ...
    public static String zg2uni(String input) {
        ...
        rule.put("\u108a", "\u103d\u103e");
        rule.put("\u103B\u1064", "\u1064\u103B");
        rule.put("\u103c([\u1000-\u1021])([\u1064\u108b\u108d])", "$1\u103c$2");
        rule.put("(\u1031)?([\u1000-\u1021\u1040-\u1049])(\u103c)?\u1064", "\u1004\u103a\u1039$1$2$3");
        rule.put("(\u1031)?([\u1000-\u1021])(\u103b|\u103c)?\u108b", "\u1004\u103a\u1039$1$2$3\u102d");
        rule.put("(\u1031)?([\u1000-\u1021])(\u103b)?\u108c", "\u1004\u103a\u1039$1$2$3\u102e");
        rule.put("(\u1031)?([\u1000-\u1021])([\u103b\u103c])?\u108d", "\u1004\u103a\u1039$1$2$3\u1036");
        rule.put("\u108e", "\u102d\u1036");
        rule.put("\u108f", "\u1014");
        rule.put("\u1090", "\u101b");
        rule.put("\u1091", "\u100f\u1039\u100d");
        ...
        rule.put("([^\u1040\u1041\u1042\u1043\u1044\u1045\u1046\u1047\u1048\u1049])\u1040\u102b", "$1\u101d\u102b");
        rule.put("([\u1040\u1041\u1042\u1043\u1044\u1045\u1046\u1047\u1048\u1049])\u1040\u102b(?!\u1038)", "$1\u101d\u102b");
        rule.put("^\u1040(?=\u102b)", "\u101d");
        rule.put("\u1040\u102d(?!\u0020?/)", "\u101d\u102d");
