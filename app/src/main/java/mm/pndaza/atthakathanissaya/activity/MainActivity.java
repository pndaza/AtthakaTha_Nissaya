...
import mm.pndaza.atthakathanissaya.adapter.AtthaBookAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AtthaBookAdapter adapter = new AtthaBookAdapter(this, paliBookList);
